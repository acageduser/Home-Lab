...
[ ] Keep notes in Git (configs, .env.example, README.txt).
...
[ ] Install Tailscale:  sudo apt install tailscale && sudo tailscale up --ssh
[ ] Enable WoL in BIOS; ethtool -s <nic> wol g
...
- RustDesk tutorial: https://www.youtube.com/watch?v=x9A7MuAvDlQ
...
[ ] Install Docker + Compose:  sudo apt install docker.io docker-compose-plugin
...
Note: YouTube app ads mostly bypass DNS. Use uBlock in browsers, AdGuard app
on Android, SmartTube on TV, or Premium.
...
[ ] Set EULA=TRUE, TYPE=FABRIC, MEMORY=4G; map /data; port 25565 internal only.
